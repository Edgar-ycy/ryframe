...
pub const ALPHANUMERIC_ALPHABET: &[u8] = b"ACDEFHJKLMNPQRTUVWXY3479";
pub const ALPHANUMERIC_LENGTH: usize = 4;
...
pub fn generate_challenge_with(rng: &mut impl Rng, captcha_type: CaptchaType) -> Challenge {
    match captcha_type {
