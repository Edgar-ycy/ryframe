...
VALUES (1, 'system', '系统租户', 'enabled')"####,
    ...
    r####"INSERT INTO `sys_cache_namespace_version` (`tenant_id`, `namespace`, `version`)
VALUES ('system', 'config', 0)"####,
    ...
    r####"CREATE TABLE IF NOT EXISTS `password_reset_requests` (
    ...
    r####"CREATE TABLE IF NOT EXISTS `sys_permission` (
    ...
    r####"CREATE TABLE IF NOT EXISTS `sys_login_info` (
    `id`              BIGINT       NOT NULL                COMMENT '日志ID',
    `tenant_id`       VARCHAR(64)  NOT NULL DEFAULT 'system' COMMENT '租户ID',
    ...
    r####"CREATE TABLE IF NOT EXISTS `sys_role_permission` (
    `tenant_id` VARCHAR(64) NOT NULL DEFAULT 'system' COMMENT '租户ID',
    `role_id`  BIGINT NOT NULL  COMMENT '角色ID',
    ...
    r####"CREATE TABLE IF NOT EXISTS `sys_file` (
    ...
    r####"CREATE TABLE IF NOT EXISTS `sys_background_job` (
    ...
    r####"INSERT INTO `sys_dept` (`id`, `name`, `parent_id`, `ancestors`, `sort`, `status`) VALUES
    ...
    (5, '后端组',         2,    '0,1,2',   1, '1'),
    (6, '前端组',         2,    '0,1,2',   2, '1')"####,
    r####"INSERT INTO `sys_role` (`id`, `name`, `code`, `is_super`, `data_scope`, `status`, `sort`, `remark`) VALUES
    ...
    r####"INSERT INTO `sys_menu` (`id`, `name`, `parent_id`, `menu_type`, `perm_id`, `route_key`, `icon`, `sort`, `visible`, `status`) VALUES
    ...
    r####"INSERT INTO `sys_job_schedule`
    ...
    (2, 'system', '消息过期清理', 'system.message_retention_cleanup', '0 5 0 * * * *', 'UTC', 1, 'fire_once', 'forbid', 900, UTC_TIMESTAMP(6), NULL, 1, '0', UTC_TIMESTAMP(6), UTC_TIMESTAMP(6))"####,
    r####"INSERT INTO `sys_post` (`id`, `name`, `code`, `sort`, `status`, `remark`) VALUES
    ...
    r####"INSERT INTO `sys_dict_data` (`id`, `type_code`, `label`, `value`, `sort`, `status`, `css_class`) VALUES
    ...
    (1, 1),
    (2, 2)"####,
    r####"INSERT INTO `sys_role_permission` (`role_id`, `perm_id`) VALUES
    (1, 12),
