...
impl MigrationTrait for Migration {
    ...
    async fn down(&self, _manager: &SchemaManager) -> Result<(), DbErr> {
        // Baseline rollback would destroy application data and is intentionally unsupported.
        Ok(())
    }
}

// Canonical executable schema and bootstrap data. sql/ryframe_config.sql is a
// generated review snapshot only and is never used by runtime/deployment tools.
