...
pub fn port(database: ControlDatabaseCluster) -> Arc<dyn RetentionCleanupPersistencePort> {
    Arc::new(LegacyRetentionCleanupPersistence { database })
}

struct LegacyRetentionCleanupPersistence {
    database: ControlDatabaseCluster,
}

impl RetentionCleanupPersistencePort for LegacyRetentionCleanupPersistence {
    fn preview<'a>(
        &'a self,
