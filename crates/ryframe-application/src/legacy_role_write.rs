...
struct LegacyRoleWrite {
    database: ryframe_db::ControlDatabaseCluster,
    authorization_cache: AuthorizationCache,
    product_service: Arc<ProductService>,
}

struct LegacyRoleWriteTransaction {
    transaction: sea_orm::DatabaseTransaction,
    authorization_cache: AuthorizationCache,
    product_service: Arc<ProductService>,
}

impl RoleWritePort for LegacyRoleWrite {
    fn begin(&self) -> PersistenceFuture<'_, Box<dyn RoleWriteTransaction>> {
        Box::pin(async move {
            ...
            Ok(Box::new(LegacyRoleWriteTransaction {
                transaction,
...
impl RoleWriteTransaction for LegacyRoleWriteTransaction {
...
impl ControlTransaction for LegacyRoleWriteTransaction {
