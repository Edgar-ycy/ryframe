...
pub fn port(database: ControlDatabaseCluster) -> Arc<dyn IdentityAuthorizationReadPort> {
    Arc::new(LegacyIdentityAuthorization { database })
}

struct LegacyIdentityAuthorization {
    database: ControlDatabaseCluster,
}

impl IdentityAuthorizationReadPort for LegacyIdentityAuthorization {
    fn tenant<'a>(
        &'a self,
        tenant_id: &'a str,
...
fn to_user(user: ryframe_db::entities::user::Model) -> IdentityUserRecord {
    IdentityUserRecord {
        id: user.id,
