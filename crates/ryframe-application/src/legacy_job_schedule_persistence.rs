...
use crate::{
    ...
    PersistenceFuture, jobs::database_enqueue, legacy_execution_tenant_scope::database_scope,
};
...
impl JobSchedulePersistencePort for LegacyJobSchedulePersistence {
    ...
    fn begin(&self) -> PersistenceFuture<'_, Box<dyn JobScheduleTransaction>> {
        Box::pin(async move {
            ...
            Ok(Box::new(LegacyJobScheduleTransaction {
                transaction,
...
struct LegacyJobScheduleTransaction {
    transaction: DatabaseTransaction,
    schedule_repository: JobScheduleRepository,
    job_repository: BackgroundJobRepository,
}

impl JobScheduleTransaction for LegacyJobScheduleTransaction {
