...
use crate::{
    PersistenceFuture, ServiceAccountAuthorizationReadPort, ServiceAccountPermissionSnapshot,
...
pub fn port(database: ControlDatabaseCluster) -> Arc<dyn ServiceAccountAuthorizationReadPort> {
    Arc::new(LegacyServiceAccountAuthorizationPersistence { database })
}

struct LegacyServiceAccountAuthorizationPersistence {
    database: ControlDatabaseCluster,
}

impl ServiceAccountAuthorizationReadPort for LegacyServiceAccountAuthorizationPersistence {
