...
pub fn port(
    ...
    Arc::new(LegacyProfilePersistence {
        database,
        authorization_cache,
    })
}

struct LegacyProfilePersistence {
    database: ControlDatabaseCluster,
    authorization_cache: AuthorizationCache,
}

struct LegacyProfileTransaction {
    transaction: sea_orm::DatabaseTransaction,
    authorization_cache: AuthorizationCache,
}

impl ProfilePersistencePort for LegacyProfilePersistence {
    fn find_profile<'a>(
        &'a self,
        tenant_id: &'a str,
        user_id: i64,
    ...
    fn begin(&self) -> PersistenceFuture<'_, Box<dyn ProfileTransaction>> {
        Box::pin(async move {
            ...
            Ok(Box::new(LegacyProfileTransaction {
                transaction,
...
impl ProfileTransaction for LegacyProfileTransaction {
...
impl ControlTransaction for LegacyProfileTransaction {
