...
mod tests {
    ...
    fn test_string_types() {
        ...
        assert_eq!(db_to_rust("VARCHAR", false), "String");
        assert_eq!(db_to_rust("text", false), "String");
        assert_eq!(db_to_rust("longtext", false), "String");
        assert_eq!(db_to_rust("uuid", false), "String");
    }

    #[test]
    fn test_integer_types() {
        assert_eq!(db_to_rust("int", false), "i32");
        assert_eq!(db_to_rust("integer", false), "i32");
        assert_eq!(db_to_rust("bigint", false), "i64");
        assert_eq!(db_to_rust("smallint", false), "i16");
        assert_eq!(db_to_rust("tinyint", false), "i8");
    }

    #[test]
    fn test_float_types() {
        assert_eq!(db_to_rust("float", false), "f32");
        assert_eq!(db_to_rust("double", false), "f64");
    }

    #[test]
    fn test_bool_type() {
        assert_eq!(db_to_rust("boolean", false), "bool");
        assert_eq!(db_to_rust("bool", false), "bool");
    }

    #[test]
    fn test_datetime_types() {
        assert_eq!(db_to_rust("timestamp", false), "DateTime<Utc>");
        assert_eq!(db_to_rust("datetime", false), "DateTime<Utc>");
        assert_eq!(db_to_rust("date", false), "chrono::NaiveDate");
    }

    #[test]
    fn test_json_type() {
        assert_eq!(db_to_rust("json", false), "serde_json::Value");
        assert_eq!(db_to_rust("jsonb", false), "serde_json::Value");
    }
    ...
    fn test_nullable() {
        ...
        assert_eq!(db_to_rust("bigint", true), "Option<i64>");
    }
