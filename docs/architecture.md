...
| 仓库 | 职责 | 主要产物 |
| --- | --- | --- |
| `ryframe` | Rust 服务、数据库迁移、OpenAPI、部署配置和联合发布门禁 | 稳定版标签、项目级源码快照与 `release-manifest.json`、Nightly 源码快照 |
